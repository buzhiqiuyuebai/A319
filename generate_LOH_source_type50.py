...
""" seismic moment tensor
 ...
 x,y,z,strike, dip, rake, area, onset time.
     20.00000     5.00000     0.00000     0.00000    0.00000     0.00000  1.0     0.00000
...
momentRate = (1-2*np.pi*np.pi*fm*fm*(vtime-0.0003)*(vtime-0.0003))*np.exp(-fm*fm*np.pi*np.pi*(vtime-0.0003)*(vtime-0.0003))
